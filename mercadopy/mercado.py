...
def comprar_produto() -> None:
    if len(produtos) > 0:
        print('Informe o código do produto que deseja colocar no carrinho')
        print('----------------------------------------------------------')
        ...
        if produto:
            if len(carrinho) > 0:
                ...
                for item in carrinho:
                    quant: int = item.get(produto)  # o get aqui está sendo usado pois o item 'produto' é um dicionário.
                    if quant:
